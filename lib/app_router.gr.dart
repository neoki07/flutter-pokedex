...
import 'package:flutter_pokedex/routes/hoge_page.dart' as _i1;
import 'package:flutter_pokedex/routes/pokemon_detail_page.dart' as _i2;
...
class PokemonDetailRoute extends _i3.PageRouteInfo<PokemonDetailRouteArgs> {
  PokemonDetailRoute({
    ...
    List<_i3.PageRouteInfo>? children,
         ...
         args: PokemonDetailRouteArgs(key: key, pokemonName: pokemonName),
...
class PokemonDetailRouteArgs {
  const PokemonDetailRouteArgs({this.key, required this.pokemonName});
